...
const Login = () => {
  ...
  return (
    <ScreenWrapper>
        ...
        <Button>
            <Typo size={18} fontWeight={'600'} color='black' style={{fontStyle: 'italic'}}>Login</Typo>
        </Button>

        {/* Footer */}

        <View style={styles.footer}>
            <Typo size={16} color={colors.textLighter}>Forgot your password?</Typo>
            <Typo size={16} color={colors.primary} style={styles.forgetPassword}>Reset it</Typo>
            </View>
        </View>
    </ScreenWrapper>
  )
